package com.lfx.web.controller;
...
public class UserController {
	...
	public void getUser(@PathVariable String id, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
	...
	public void allUser(ModelMap model, HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		for (User user : userList) {
			...
			userMsg = userMsg + "<td><input type='button' value='删 除' onclick='removeUser(" + user.getId()
					+ ")'/></td>";
			userMsg = userMsg + "</tr>";
		}
		ObjectMapper mapper = new ObjectMapper();
